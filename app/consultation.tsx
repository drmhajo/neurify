...
const blankForm = {
  ...
  clinicalDecision: "", surgicalIntervention: false, surgeryType: "", disposition: "follow_up" as ClinicalDisposition,
};
  ...
  const submit = () => {
    ...
    addConsultation(teamId, {
      ...
      patient: {
        ...
        clinicalDecision: form.clinicalDecision, surgeryType: form.surgicalIntervention ? form.surgeryType : undefined,
      },
    });
