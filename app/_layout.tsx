...
export default function RootLayout() {
  ...
  const [coreUiAssets, coreUiAssetsError] = useAssets([
    require("../assets/fonts/MaterialIcons.ttf"), require("../assets/fonts/MaterialCommunityIcons.ttf"), require("../assets/fonts/Cairo-Regular.ttf"), require("../assets/fonts/Cairo-SemiBold.ttf"), require("../assets/fonts/Cairo-Bold.ttf"), require("../assets/images/icon.png"), require("../assets/images/neurify-wordmark.png"), require("../assets/images/neurosurgery-department-logo.png"),
  ]);
...
function AppNavigator() {
  ...
  return <><PushNotificationBootstrap /><StatusBar style="dark" /><Stack screenOptions={{ headerShown: false, animation: "fade" }}><Stack.Screen name="index" /><Stack.Screen name="login" /><Stack.Screen name="(tabs)" options={{ animation: "fade_from_bottom" }} /><Stack.Screen name="team/[id]" options={{ presentation: "card" }} /><Stack.Screen name="patient/[teamId]/[caseId]" options={{ presentation: "card" }} /><Stack.Screen name="notifications" options={{ presentation: "card" }} /><Stack.Screen name="registration-requests" options={{ presentation: "card" }} /><Stack.Screen name="report-request-monitor" options={{ presentation: "card" }} /><Stack.Screen name="profile" options={{ presentation: "modal" }} /></Stack></>;
}
