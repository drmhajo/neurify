...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    router.replace(result.recoveryRequired ? "/profile" : "/(tabs)");
  };
...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: palette.canvas }, topDecoration: { position: "absolute", top: 0, left: 0, right: 0, height: 258, backgroundColor: palette.navy, borderBottomLeftRadius: 54, borderBottomRightRadius: 54 }, content: { flexGrow: 1, paddingHorizontal: 24, paddingTop: 72, paddingBottom: 30, alignItems: "center" }, languageToggle: { position: "absolute", top: 22, right: 22, flexDirection: "row", backgroundColor: "#FFFFFF24", padding: 3, borderRadius: 12 }, languageButton: { minWidth: 56, alignItems: "center", paddingHorizontal: 7, paddingVertical: 6, borderRadius: 9 }, languageButtonActive: { backgroundColor: "#FFFFFF" }, languageText: { color: "#D8EEF9", fontSize: 11, fontWeight: "800" }, languageTextActive: { color: palette.navy }, mark: { width: 94, height: 94, borderRadius: 30, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center", borderWidth: 4, borderColor: "#FFFFFF55", overflow: "hidden" }, logo: { width: 88, height: 88 }, title: { marginTop: 14, color: "#FFFFFF", fontSize: 25, fontWeight: "900", textAlign: "center" }, subtitle: { marginTop: 5, color: "#D8EEF9", fontSize: 14, fontWeight: "700" }, description: { color: "#526D82", fontSize: 14, lineHeight: 22, textAlign: "center", marginTop: 52, marginBottom: 18, paddingHorizontal: 16 }, form: { width: "100%", backgroundColor: "#FFFFFF", borderRadius: 22, padding: 20, borderWidth: 1, borderColor: palette.line, shadowColor: palette.navy, shadowOpacity: 0.1, shadowRadius: 20, shadowOffset: { width: 0, height: 9 }, elevation: 3 }, formTitle: { color: palette.ink, fontSize: 19, fontWeight: "900", marginBottom: 18 }, label: { color: palette.ink, fontSize: 13, fontWeight: "800", marginBottom: 7 }, inputShell: { height: 50, borderColor: palette.line, borderWidth: 1, borderRadius: 14, flexDirection: "row", alignItems: "center", paddingHorizontal: 13, gap: 9, marginBottom: 14 }, input: { flex: 1, color: palette.ink, fontSize: 14 }, registrationButton: { minHeight: 45, marginTop: 11, backgroundColor: palette.paleTeal, borderColor: "#A7DCD2", borderWidth: 1, borderRadius: 13, alignItems: "center", justifyContent: "center", flexDirection: "row-reverse", gap: 8 }, registrationButtonText: { color: palette.teal, fontSize: 12, fontWeight: "900" }, centralInfo: { marginTop: 14, flexDirection: "row-reverse", alignItems: "center", gap: 6, backgroundColor: "#E7F7F3", padding: 10, borderRadius: 12 }, centralInfoText: { color: "#075E54", fontSize: 11, lineHeight: 17, flex: 1 }, modalShade: { flex: 1, backgroundColor: "#102A4370", justifyContent: "flex-end" }, sheet: { maxHeight: "91%", backgroundColor: "#FFFFFF", borderTopLeftRadius: 28, borderTopRightRadius: 28 }, sheetContent: { padding: 20, paddingBottom: 38 }, handle: { width: 40, height: 4, borderRadius: 3, backgroundColor: palette.line, alignSelf: "center", marginBottom: 15 }, sheetTitle: { color: palette.ink, fontSize: 20, fontWeight: "900" }, sheetText: { color: palette.muted, fontSize: 12, lineHeight: 18, marginTop: 6, marginBottom: 7 }, registerFieldLabel: { color: palette.ink, fontSize: 12, fontWeight: "800", marginTop: 11, marginBottom: 5 }, registerFieldInput: { minHeight: 47, borderWidth: 1, borderColor: palette.line, borderRadius: 12, paddingHorizontal: 12, color: palette.ink, fontSize: 13, backgroundColor: "#FCFEFE" }, cancelRegistration: { minHeight: 42, marginTop: 8, alignItems: "center", justifyContent: "center" }, cancelRegistrationText: { color: palette.muted, fontSize: 13, fontWeight: "800" }, footnote: { color: palette.muted, fontSize: 11, textAlign: "center", lineHeight: 17, marginTop: 18, paddingHorizontal: 12 },
});
