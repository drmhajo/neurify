...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, minWidth: 0, color: loginColors.ink, fontSize: 14 },
  ...
  registrationButtonText: { color: loginColors.teal, fontSize: 12, fontWeight: "900", flexShrink: 1, textAlign: "center" },
  centralInfo: { marginTop: 14, alignItems: "center", gap: 6, backgroundColor: loginColors.goldPale, padding: 10, borderRadius: 12 },
  centralInfoText: { color: "#6C5D17", fontSize: 11, lineHeight: 17, flex: 1, minWidth: 0 },
