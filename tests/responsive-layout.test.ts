...
describe("التخطيط المتجاوب على الهواتف", () => {
  it("يقلل المسافات والعناصر الثانوية على الهاتف الضيق أو القصير دون خفض أهداف اللمس", () => {
    ...
    expect(compact).toMatchObject({ isCompact: true, isShort: true, screenPadding: 14, loginLogoSize: 106, tabHeight: 58, tabLabelSize: 8 });
    expect(standard).toMatchObject({ isCompact: false, isShort: false, loginLogoSize: 124, tabHeight: 64, tabLabelSize: 10 });
